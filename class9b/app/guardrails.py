"""Product-edge policy. Sits in front of orch-serve. Does not admit / place / shed.

Preferred models are local vLLM (text / vision, or TEXT_MODEL / VISION_MODEL).
Superlinked is overflow only — router/overflow.py on 503, not this file.
Open WebUI, Locust, and Crew POST to orch-serve. `gateway.serve` calls inspect()
before admit / place. `python -m app.harness` proves the same rules on the laptop.
"""
