"""App-layer harness. Proves the orch-serve allowlist. Does not admit / place / shed.

Default: inspect() on the laptop (no cluster).
--live: POST orch-serve :8080 (ORCH_URL). Not vLLM :8000.
"""
